...
import { Building2, MapPin, Phone, Mail, Clock, FileText, Save, AlertCircle, CheckCircle, Shield } from 'lucide-react';
...
const InsuranceProfile = () => {
  ...
  const fetchProfile = async () => {
    try {
      ...
      const response = await insuranceAPI.getProfile();
      if (response.success && response.data) {
        ...
        setFormData({
          ...
          coverageTypes: response.data.coverageTypes || [],
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.companyName || !formData.companyRegistrationNumber || !formData.licenseNumber || !formData.phone || !formData.email) {
    ...
    try {
      setLoading(true);
      const response = await insuranceAPI.createOrUpdateProfile(formData);
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl font-semibold text-white mb-2">Insurance Profile</h1>
        <p className="text-gray-400">
          {hasProfile ? 'Update your insurance company information' : 'Create your insurance profile to start uploading documents'}
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                rows="3"
                className="w-full px-4 py-2 bg-white/5 border border-white/10 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-blue-400"
                placeholder="Brief description of your insurance company"
              />
            </div>
          </div>
        </div>
