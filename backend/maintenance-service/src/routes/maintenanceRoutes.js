...
router.get('/:id', authMiddleware, authorize('admin', 'agency'), maintenanceController.showbyId);
...
router.put('/:id', authMiddleware, authorize('admin', 'agency'), validateMaintenanceUpdate, maintenanceController.update);
router.delete('/delete/:id', authMiddleware, authorize('admin'), maintenanceController.deletemaintenance);
router.delete('/:id', authMiddleware, authorize('admin'), maintenanceController.deletemaintenance);
